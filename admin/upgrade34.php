...
if ($step==1) {
  ...
  <li>Upgrading from vBulletin 2.3.0: run <i><? echo createupgradelist(24,$scriptnumber); ?></i>
  <li>Upgrading from vBulletin 2.3.1: run <i><? echo createupgradelist(25,$scriptnumber); ?></i>
  <li>Upgrading from vBulletin 2.3.2: run <i><? echo createupgradelist(26,$scriptnumber); ?></i>
  <li>Upgrading from vBulletin 2.3.3: run <i><? echo createupgradelist(27,$scriptnumber); ?></i>
  <li>Upgrading from vBulletin 2.3.4: run <i><? echo createupgradelist(28,$scriptnumber); ?></i>
  <li>Upgrading from vBulletin 2.3.5: run <i><? echo createupgradelist(29,$scriptnumber); ?></i>
  <li>Upgrading from vBulletin 2.3.6: run <i><? echo createupgradelist(30,$scriptnumber); ?></i>
  <li>Upgrading from vBulletin 2.3.7: run <i><? echo createupgradelist(31,$scriptnumber); ?></i>
  <li>Upgrading from vBulletin 2.3.8: run <i><? echo createupgradelist(32,$scriptnumber); ?></i>
  <li>Upgrading from vBulletin 2.3.9: run <i><? echo createupgradelist(33,$scriptnumber); ?></i>
  <li>Upgrading from vBulletin 2.3.10: run <i><? echo createupgradelist(34,$scriptnumber); ?></i>
  </ul>
...
if ($step==2) {
  ...
  // Remove the infernal image size bypass setting
  $DB_site->query("DELETE FROM setting WHERE varname = 'allowimgsizefailure'");
  echo "Done!<p>\n";
