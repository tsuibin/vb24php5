...
if ($step==3) {
  // update coppa link
  echo "Updating COPPA link .... ";
  $DB_site->query("UPDATE setting SET description='Use the COPPA registration system. This complies with the COPPA laws and requires children under the age of 13 to get parental consent before they can post. For more info about this law, see here:<br>\r\n<a href=\"http://www.ftc.gov/opa/1999/10/childfinal.htm\">http://www.ftc.gov/opa/1999/9910/childfinal.htm</a>' WHERE varname='usecoppa'");
